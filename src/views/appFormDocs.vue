    ...
    <div>
        ...
        <div class="border-round p-5" style="background-color: var(--color-card);">
            <ol class="p-4">
                    ...
                    <div class="border-round p-4" style="background-color: var(--color-card);">
                        <li>
                            <h3 class="flex">Description: <p class="mx-2">The sections object defines the sections and 
                                ...
                                the section name and the value is an array or an object representing the fields and the options for that section.</p>
                            </h3>
                            <p class="my-2 text-lg text-white">You can set some options for each section of inputs you define : </p>
                            <ul>
                                <li><h3>isTitleHidden (optiona; , boolean) :</h3> <p>Responsible for showing or hiding the section title</p></li>
                                <li><h3>isTransparent (optiona; , boolean) :</h3> <p>Responsible for setting a background for the section or removing it</p></li>
                            </ul>
                        ...
                        <li>
                            <h3 class="flex">Custom Component Field: <p class="mx-2 w-9">You can use custom components as form fields
                                 by specifying the $cmp property in the field object. The custom component should be registered 
                ...
                <ul class="my-2">
                    <div class="border-round p-4" style="background-color: var(--color-card);">
                        <p>The submitHandler object configures the form submission behavior. It accepts the following properties:</p>
                        <li class="my-2">
                            <h3 >endpoint (Function, required) :<br> <p class="mx-2 w-11">The function that will be 
                                called when the form is submitted. This function should handle the form data submission to your API or backend.</p>
                            </h3>
                            <h4 class="text-base m-2">example : <span class="font-bold text-white">endpoint: apiClient.roleCreate</span></h4>
                        ...
                        <li class="my-2">
                            ...
                            <h4 class="text-base m-2">example : <span class="font-bold text-white">redirectRoute: "roles_list"</span></h4>

                        </li>
                        <li class="my-2">
                            <h3 class="">mapFunction (Optional,Function) : <p class="mx-2">This optional function allows
                                 for manipulation of the request that we got from the form data , enabling the reformatting
                                  of the request to align with specific requirements before executing the submit function so
                ...
                <ul class="my-2">
                    <div class="border-round p-4" style="background-color: var(--color-card);">
                        <li><p class="my-2 text-white text-lg">The findHandler prop is a crucial property that determines the 
                        ...
                        <li>
                        <p class="my-2 text-white text-lg">findHanlder contains the same properties of the submitHandler except for a redirect route</p>
                        </li>
                        <li>
                        ...
                        <li>
                        <p class="my-2 text-white text-lg">On the other hand, when the findHandler prop is included and an endpoint is provided, the 
                            AppForm component is used for updating an existing entry. The findHandler function plays a vital
                            role in this scenario. It is responsible for retrieving the data associated with the entry to be
                            updated. This data is then used to populate the form fields, providing a convenient way to edit 
